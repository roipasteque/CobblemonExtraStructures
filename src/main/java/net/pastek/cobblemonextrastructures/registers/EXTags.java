...
public class EXTags {
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ExtraStructures.MOD_ID, name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(ExtraStructures.MOD_ID, name));
        }
    }
